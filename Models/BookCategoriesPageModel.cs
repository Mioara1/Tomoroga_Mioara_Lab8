...
namespace Tomoroga_Mioara_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Tomoroga_Mioara_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Tomoroga_Mioara_Lab8Context context,
